...
namespace Ozone.Infrastructure.Persistence.Models
{
    public partial class OzoneContext : DbContext
    {
        ...
        public virtual DbSet<WorkProgressHistory> WorkProgressHistory { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=WINDOWS-K8ME0A1; Initial Catalog=Ozone; user id=sa;password=123qwe; integrated security=True; ");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Asset>(entity =>
            {
                entity.HasOne(d => d.Building)
                    ...
                    .HasConstraintName("FK_Asset_Buildings");
            });
            ...
            {
                entity.Property(e => e.FlatPrefix).IsFixedLength(true);

                entity.Property(e => e.FloorPrefix).IsFixedLength(true);
                entity.Property(e => e.FloorParkingPrefix).IsFixedLength(true);

                entity.Property(e => e.ParkingPrefix).IsFixedLength(true);
                ...
                entity.HasOne(d => d.Client)
                    ...
                    .HasConstraintName("FK_Buildings_Client");
                ...
                entity.HasOne(d => d.State)
                    ...
                    .HasConstraintName("FK_Buildings_State");
            });
            ...
            modelBuilder.Entity<Flats>(entity =>
            {
                entity.HasOne(d => d.Building)
                    .WithMany(p => p.Flats)
                    .HasForeignKey(d => d.BuildingId)
                    .HasConstraintName("FK_Flats_Buildings");

                entity.HasOne(d => d.Floor)
                    .WithMany(p => p.Flats)
                    .HasForeignKey(d => d.FloorId)
                    .HasConstraintName("FK_Flats_Floors");

                entity.HasOne(d => d.ParkingSlot)
                    .WithMany(p => p.Flats)
                    .HasForeignKey(d => d.ParkingSlotId)
                    .HasConstraintName("FK_Flats_ParkingSlot");
            });
            ...
            modelBuilder.Entity<Floors>(entity =>
            {
                ...
                entity.HasOne(d => d.FloorType)
                    ...
                    .HasConstraintName("FK_Floor_Type");
            });
            ...
            modelBuilder.Entity<ParkingSlots>(entity =>
            {
                entity.HasOne(d => d.Building)
                    ...
                    .HasForeignKey(d => d.BuildingId)
                    .HasConstraintName("FK_ParksingSlot_Building");

                entity.HasOne(d => d.Floor)
                    .WithMany(p => p.ParkingSlots)
                    .HasForeignKey(d => d.FloorId)
                    .HasConstraintName("FK_ParkingSlot_Floor");
            });
            ...
            modelBuilder.Entity<SecUser>(entity =>
            {
                entity.HasOne(d => d.ApprovelStatus)
                    ...
                    .HasConstraintName("FK__SecUser__Approve__0662F0A3");

                entity.HasOne(d => d.Building)
                    .WithMany(p => p.SecUser)
                    .HasForeignKey(d => d.BuildingId)
                    .HasConstraintName("FK_SecUser_Buildings");
                ...
                entity.HasOne(d => d.Flat)
                    ...
                    .HasConstraintName("FK_SecUser_Flats");

                entity.HasOne(d => d.Floor)
                    .WithMany(p => p.SecUser)
                    .HasForeignKey(d => d.FloorId)
                    .HasConstraintName("FK_SecUser_Floors");
            ...
            modelBuilder.Entity<ServiceRequest>(entity =>
            {
                entity.HasOne(d => d.Building)
                    ...
                    .HasForeignKey(d => d.BuildingId)
                    .HasConstraintName("FK_ServiceRequest_Buildings");

                entity.HasOne(d => d.Client)
                    .WithMany(p => p.ServiceRequest)
                    .HasForeignKey(d => d.ClientId)
                    .HasConstraintName("FK_ServiceRequest_Client");

                entity.HasOne(d => d.Flat)
                    .WithMany(p => p.ServiceRequest)
                    .HasForeignKey(d => d.FlatId)
                    .HasConstraintName("FK_ServiceRequest_Flats");

                entity.HasOne(d => d.Priority)
                    .WithMany(p => p.ServiceRequest)
                    .HasForeignKey(d => d.PriorityId)
                    .HasConstraintName("FK_ServiceRequest_Priority");

                entity.HasOne(d => d.ServiceType)
                    .WithMany(p => p.ServiceRequest)
                    .HasForeignKey(d => d.ServiceTypeId)
                    .HasConstraintName("FK_ServiceRequest_ServiceType");

                entity.HasOne(d => d.Status)
                    .WithMany(p => p.ServiceRequest)
                    .HasForeignKey(d => d.StatusId)
                    .HasConstraintName("FK_ServiceRequest_Status");
            });
