...
{
    public partial class OzoneServerDBContext : DbContext
    {
        public OzoneServerDBContext()
        {
        }

        public OzoneServerDBContext(DbContextOptions<OzoneServerDBContext> options)
            : base(options)
        {
        }
...
//                optionsBuilder.UseSqlServer("Data Source=DESKTOP-PE36NEL;Initial Catalog=OzoneServerDB;user id=farooq;password=123qwe;integrated security=True;");
//            }
//        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<SecUser>(entity =>
            {
                entity.HasOne(d => d.ApprovelStatus)
                    ...
                    .HasConstraintName("FK__SecUser__Approve__019E3B86");
